if shared.VapeExecuted then
	...
	local function vapeGithubRequest(scripturl)
		if not isfile("vape/"..scripturl) then
			local suc, res = pcall(function() return game:HttpGet("https://raw.githubusercontent.com/endmylifehahahahahahahahaha/VoidwareBakup/"..readfile("vape/commithash2.txt").."/"..scripturl, true) end)
			assert(suc, res)
